...
- [x] Extraction benchmark: exact match and macro field F1
...
Phase 8 does not execute experiments, generate hypotheses, claim global novelty, or perform autonomous research loops.
